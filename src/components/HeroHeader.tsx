...
export default function HeroHeader({ title, subtitle, mainHeader }: { title: string, subtitle?: string, mainHeader?: boolean }) {
  return (
    <div className={`relative flex overflow-hidden -mt-12 min-h-[250px] ${mainHeader ? "sm:min-h-[600px]" : "sm:min-h-[300px]"}`}>
      ...
      <div className="relative z-10 m-auto flex flex-col justify-center min-h-[200px] max-w-5xl items-center px-4 py-8 sm:px-6 lg:px-8">
          <h1 className="text-4xl font-bold tracking-tight text-white drop-shadow-md sm:text-7xl text-center text-shadow-lg">
            {title}
          </h1>
          {subtitle && (
